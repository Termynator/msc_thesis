...
big_disk_data_path = '/data/simtb_ds/experiment_01/spk_niis/'
npy_path = 'numpys/'
model_path = 'models/'
yaml_path = 'yamls/'
...
for epoch in range(200):
    ...
    # Update stats.
    stats.update()
    stats.save('simtb_exp_01')
    torch.save(net,os.path.join(model_path,'simtb_exp_01.net'))
