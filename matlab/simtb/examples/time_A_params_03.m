...
TC_block_n = 6;          % Number of blocks [set = 0 for no block design]
...
TC_block_length = 5;    % length of each block (in samples)
TC_block_ISI    = 5;    % length of OFF inter-stimulus-intervals (in samples)
TC_block_amp    = zeros(nC, TC_block_n);    % [nC x TC_block_n] matrix of task-modulation amplitudes
